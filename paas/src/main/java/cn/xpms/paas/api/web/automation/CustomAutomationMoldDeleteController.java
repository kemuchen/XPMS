...
public class CustomAutomationMoldDeleteController {
    ...
    public ApiResponseEntity deleteCustomAutomation(@PathVariable("id") Integer id) throws AppException {
        return customAutomationService.deleteCustomAutomation(id);
    }
}
