package cn.xpms.system.framework.beans.entity;
...
public class ApiResponseEntity {
     ...
     */
    public ApiResponseEntity(String code, String message, Map<Object, Object> data) {
        this.code = code;
     ...
     * @Author: YCJ
     */
    public ApiResponseEntity(String code, Object data) {
        this.code = code;
        this.data = data;
    }
    ...
    public ApiResponseEntity(BaseErrorCode errorCode, Object data) {
     ...
     */
    public ApiResponseEntity(BaseErrorCode errorCode) {
        this.code = errorCode.getError_code();
        this.message = errorCode.getError_desc();
    }
