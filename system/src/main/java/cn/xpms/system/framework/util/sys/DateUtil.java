...
public class DateUtil {
     ...
     * @Params: [day, isWeekdays]
     * @return: java.util.Date
     * @Author: 柯雷
     * @Date: 2020/11/3 16:06
     */
    public static Date addDate(int day, boolean isWeekdays) {
    ...
    public static String addDate(Date date, int day, boolean isWeekdays, String format) {
        ...
        return dateFormat.format(addDate(date, day, isWeekdays)); // 将毫秒数转换成日期
    }

    /**
     * @Description: 日期增加天数
     * @Params: [date, day, isWeekdays]
     * @return: java.util.Date
     * @Author: 柯雷
     * @Date: 2020/11/3 16:05
     */
    public static Date addDate(Date date, int day, boolean isWeekdays) {
     ...
     */
    public static Date addTimestamp(int t) {
        return addTimestamp(new Date(), t);
    }
     ...
     */
    public static Date addTimestamp(Date date, int t) {
